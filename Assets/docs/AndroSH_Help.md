...
options:
  ...
  -f, --rootfs ROOTFS   Custom rootfs file, when used you don't need to add
                        -d/-t arguments
  -d, --distro {alpine,debian,ubuntu,kali-nethunter,archlinux,fedora-legacy,void,manjaro,chimera,opensuse,debian-12,ubuntu-lts,fedora}
...
options:
  ...
  --file, -f FILE       Custom filename for downloaded archive
```
